...
porcelaniush = Material(diffuse= (0.854,0.850 , 0.843), spec = 100, matType = OPAQUE)
verdeEsmeralda = Material(diffuse = (0.0, 0.8, 0.0), spec = 95)
...
rtx.scene.append( Sphere(V3(0,-1,-10), 1,  material =verdeEsmeralda)  )
